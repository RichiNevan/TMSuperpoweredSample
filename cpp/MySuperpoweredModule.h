...
#include <jsi/jsi.h>
#include <NativeSpecs.h>  // this path might need adjusting depending on where it's generated
...
class MySuperpoweredModule : public NativeMSMSpec<jsi::Value> {
 public:
  ...
  jsi::Value startOscillators(jsi::Runtime& rt, jsi::Value freqL, jsi::Value waveformL, jsi::Value freqR, jsi::Value waveformR, jsi::Value initialVolume) override;
  jsi::Value stopOscillators(jsi::Runtime& rt) override;
};
